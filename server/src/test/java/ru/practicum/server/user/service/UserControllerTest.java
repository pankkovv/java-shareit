...
public class UserControllerTest {
    ...
    void getAllUsersTest() throws Exception {
        ...
        List<UserDto> listUserDto = List.of(UserDto.builder().id(1L).name("User").email("user@user.ru").build());
    ...
    void getUserByIdTest() throws Exception {
        UserDto userDto = UserDto.builder().id(1L).name("User").email("user@user.ru").build();
        when(userService.getByUserId(any()))
                .thenReturn(userDto);
    ...
    @Test
    void updateLastUser() throws Exception {
        UserDto userDto = UserDto.builder().id(1L).name("User").email("user@user.ru").build();
    ...
    @Test
    void deleteLastUserTest() throws Exception {
        UserDto userDto = UserDto.builder().id(1L).name("User").email("user@user.ru").build();
        when(userService.updateUser(any(), any()))
                .thenReturn(userDto);
