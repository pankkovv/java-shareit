...
//
//    @GetMapping
//    List<BookingDto> getByIdListBookings(@NotNull @RequestHeader("X-Sharer-User-Id") Long userId,
...
//
//    @GetMapping("/owner")
//    List<BookingDto> getByIdOwnerBookingItems(@NotNull @RequestHeader("X-Sharer-User-Id") Long userId,
//    @RequestParam(required = false, defaultValue = "ALL") String state,
//    @RequestParam (required = false) Integer from,
//    @RequestParam (required = false) Integer size) {
